              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="models/traitement-login.php?fonction=<?=$_GET['fonction']?>">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" name="login" type="submit">se connecter</button>
                    </div>
                    <?php if($_GET['fonction']=="client"){?>
                    <div class="col-12">
                      <p class="small mb-0">vous avez un compte? <a href="compte.php">Créez votre compte</a></p>
                    </div>
                    <?php  } ?>
                  </form>
